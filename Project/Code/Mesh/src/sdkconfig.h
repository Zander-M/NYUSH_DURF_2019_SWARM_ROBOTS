...
#define CONFIG_MESH_ROUTER_SSID="zdrm"
#define CONFIG_MESH_ROUTER_PASSWD="zdrmtest"
#define CONFIG_WIFI_AUTH_OPEN=
#define CONFIG_WIFI_AUTH_WPA_PSK=
#define CONFIG_WIFI_AUTH_WPA2_PSK=y
#define CONFIG_WIFI_AUTH_WPA_WPA2_PSK=
